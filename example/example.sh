...
if [ `uname -o` = "Msys" ]; then
  g++ example/example.cpp apiprocess/process.cpp -o xproc.exe -I. -std=c++17 -DNULLIFY_STDERR -Wall -fsanitize=undefined -fno-sanitize-recover=undefined -g -ggdb -static-libgcc -static-libstdc++ -static -lntdll -Wl,--subsystem,console; ./xproc.exe;
